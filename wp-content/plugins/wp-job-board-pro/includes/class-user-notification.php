	...
	public static function display_notify($args) {
		...
		switch ($type) {
			...
			case 'create_meeting':
				...
				$html = sprintf(__('A new meeting is created on your job \'<a href="%s">%s</a>\' by \'<a href="%s">%s</a>\'.', 'wp-job-board-pro'), get_permalink($job_id), get_the_title($job_id), get_permalink($employer_id), get_the_title($employer_id) );
				break;
			case 'reschedule_meeting':
				...
				$html = sprintf(__('A meeting is re-schedule on your job \'<a href="%s">%s</a>\' by \'<a href="%s">%s</a>\'.', 'wp-job-board-pro'), get_permalink($job_id), get_the_title($job_id), get_permalink($employer_id), get_the_title($employer_id) );
				break;
			case 'reject_applied':
				$employer_id = !empty($args['employer_id']) ? $args['employer_id'] : '';
				$job_id = !empty($args['job_id']) ? $args['job_id'] : '';
