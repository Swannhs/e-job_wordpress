...
class WP_Job_Board_Pro_Scripts {
	...
	public static function enqueue_frontend() {
	    ...
	    wp_register_script( 'control-geocoder', WP_JOB_BOARD_PRO_PLUGIN_URL . 'assets/js/leaflet/Control.Geocoder.js', array( 'jquery' ), '1.5.1', true );
	    wp_register_script( 'esri-leaflet', WP_JOB_BOARD_PRO_PLUGIN_URL . 'assets/js/leaflet/esri-leaflet.js', array( 'jquery' ), '1.5.1', true );
	    wp_register_script( 'esri-leaflet-geocoder', WP_JOB_BOARD_PRO_PLUGIN_URL . 'assets/js/leaflet/esri-leaflet-geocoder.js', array( 'jquery' ), '1.5.1', true );
	    wp_register_script( 'leaflet-markercluster', WP_JOB_BOARD_PRO_PLUGIN_URL . 'assets/js/leaflet/leaflet.markercluster.js', array( 'jquery' ), '1.5.1', true );
	    wp_register_script( 'leaflet-HtmlIcon', WP_JOB_BOARD_PRO_PLUGIN_URL . 'assets/js/leaflet/LeafletHtmlIcon.js', array( 'jquery' ), '1.5.1', true );
